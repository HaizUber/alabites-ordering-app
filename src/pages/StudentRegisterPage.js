        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white/90">
              Register your account now and start ordering your favorite food
              from FEU Alabang's best concessionaires.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Use at least 6 characters, including uppercase, lowercase, digit, and special character.
                </p>
              </div>
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                <button
                  type="submit"
                  className="inline-block shrink-0 rounded-md border bg-gray-900 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-gray-900 focus:outline-none focus:ring active:text-gray-500"
                >
                  Create an account
                </button>
