...
const teamMembers = [
  {
    ...
    bio: 'Oversees project development and ensures alignment with client requirements. Leads the team in planning, execution, and delivery of the Alabites platform.'
  },
  {
    ...
    bio: 'Responsible for implementing frontend and backend functionalities to ensure smooth operation of the Alabites website. Works closely with design and QA teams.'
  },
  {
    name: 'Cain Carolino',
    role: 'Developer',
    ...
    bio: 'Develops and maintains features that enhance user experience and optimize platform performance. Collaborates with the team to integrate new technologies.'
  },
  {
    name: 'Micah Marcial',
    role: 'Designer',
    ...
    bio: 'Creates intuitive and visually appealing interfaces for the Alabites platform. Designs user interactions to enhance usability and elevate user experience.'
  },
  {
    name: 'Charles Calizo',
    role: 'Designer',
    ...
    bio: 'Responsible for visual concept development and brand consistency across all Alabites assets. Collaborates closely with development and marketing teams.'
  }
];
